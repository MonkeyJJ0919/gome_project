package cn.zcyun.xcloud.redisclient;
...
public class ShardedJedisSentinelPool extends Pool<ShardedJedis> {
    ...
    private static org.slf4j.Logger log = LoggerFactory.getLogger(ShardedJedisSentinelPool.class);
    ...
    public String getPoolInfo() {
        return "连接池总数："+internalPool.getMaxTotal()+"，创建的连接数："+internalPool.getCreatedCount()+",活动连接数："+internalPool.getNumActive()+"，空闲连接数："+internalPool.getNumIdle()+"，等待连接："+internalPool.getNumWaiters();
    }
